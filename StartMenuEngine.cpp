...
StartMenuEngine::StartMenuEngine()
{
	...
	const Vector2f startButtonLocation((middleWidth - (sizeButtons.x /2.f)), middleHeight - 100.f);
	const Vector2f exitButtonLocation((middleWidth - (sizeButtons.x / 2.f)), middleHeight + 100.f);
